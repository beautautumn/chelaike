...
<head>
  <link rel="stylesheet" type="text/css" href="${path}/static/css/login_7y.css">
  ...
  <script src="${ctx}/static/js/blueimp-md5/1.1.0/md5.min.js"></script>
    <title>启辕·汽车连锁商城管理系统-登录</title>
	<script type="text/javascript">
		// 登录
//        window.onload = function(){
//            var userName = localStorage.getItem('7yUser');
//            var passWord = localStorage.getItem('7yPwd');
...
//                localStorage.setItem('7yUser',$('#username').val());
//                localStorage.setItem('7yPwd',$('#password').val());
//            }else{
//                localStorage.removeItem('7yUser');
//                localStorage.removeItem('7yPwd');
//            }
...
<div class="login-content">
  <img src="${ctx}/static/img/car@4x.png" class="back-car">
  <div class="center">
    <div class="left">
      <p class="logo"><img src="${ctx}/static/img/logo_7y.png"></p>
      <p class="text"><img src="${ctx}/static/img/yyd-7y.png"></p>
    </div>
    <div class="right">
      <p class="login-title"><img src="${ctx}/static/img/title-7y.png"></p>
      <p class="login-user"><label><img src="${ctx}/static/img/user.png"/></label><input type="text" id="username" name="" placeholder="账号"></p>
      <p class="login-user"><label><img src="${ctx}/static/img/pwd.png"/></label><input type="password" id="password" name="" placeholder="密码" onkeydown="if(event.keyCode==13)login()"></p>
