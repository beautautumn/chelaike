...
public class UserSession implements java.io.Serializable {
	...
	List<SystemRight> systemRightList = new ArrayList<SystemRight>();
	List<SystemMenu> sysMenuList = new ArrayList<SystemMenu>();
	
	public List<SystemRight> getSystemRightList() {
		return systemRightList;
	}
	public void setSystemRightList(List<SystemRight> systemRightList) {
		this.systemRightList = systemRightList;
	}
	public List<SystemMenu> getSysMenuList() {
		return sysMenuList;
	}
	public void setSysMenuList(List<SystemMenu> sysMenuList) {
