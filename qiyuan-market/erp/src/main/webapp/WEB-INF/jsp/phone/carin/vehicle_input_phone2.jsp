...
<body>
	<div class="vInfo">
		...
		<div id="div_step1">
			<div class="h2-title">
				<span class="line"></span>车辆基本
			</div>
			<form id="myForm" action="">
				<input id="tradeId" type="hidden" name="trade.agency.id" value="${agency.id }" /> 
				<input id="wxOpenId" type="hidden" name="wxOpenId" value="${wxOpenId }" />
				<div class="list-infor01">
					<ul>
						...
						<li><a href="javascript:;">
						      ...
						      <span class="icon-mark"></span> 
						      <input type="hidden" class="input vin-code" name="picIds"></a></li>
						<li class="click">
			                ...
			                <div class="piclist wrap">
			                    <!--
			                    <dl id="dl_carImages">
					               <dd name="dd_addUploadLi"><div class="img"><input type="file" name="carImgInput" id="carImgBtn" accept="image/jpeg,image/png,image/gif,image/bmp"><img src="http://www.autoimg.cn/2scimg/m/website/20150914/pic04.jpg"></div></dd>
					               <dd name="dd_addUploadLi"><div class="img"><input type="file" name="carImgInput" id="carImgBtn2" accept="image/jpeg,image/png,image/gif,image/bmp"><img src="http://www.autoimg.cn/2scimg/m/website/20150914/pic04.jpg"></div></dd>
					               <dd name="dd_addUploadLi"><div class="img"><input type="file" name="carImgInput" id="carImgBtn3" accept="image/jpeg,image/png,image/gif,image/bmp"><img src="http://www.autoimg.cn/2scimg/m/website/20150914/pic04.jpg"></div></dd>
			                    ...
			                    <dl>                        
			                         ...
			                         <!--
			                        <dd id="companyCodeImgLi">
			                            <div class="img" id="left45">
			                                <input type="file" id="file_companyCodeImg" accept="image/jpeg,image/png,image/gif,image/bmp">
			                                <img src="http://www.autoimg.cn/2scimg/m/website/20150914/pic04.jpg">
			                            </div>
			                            <div>左前45°</div>
			                        </dd>
			                        ...
			                        <dd id="passportImgLi">
			                            <div class="img">
			                                <input type="file" id="file_passportImg" accept="image/jpeg,image/png,image/gif,image/bmp">
			                                <img src="http://www.autoimg.cn/2scimg/m/website/20150914/pic04.jpg">
			                            </div>
			                            <div>右后45°</div>
			                        </dd>
			                         <dd id="licenseImgLi">
			                            <div class="img">
			                                <input type="file" id="file_licenseImg" accept="image/jpeg,image/png,image/gif,image/bmp">
			                                <img src="http://www.autoimg.cn/2scimg/m/website/20150914/pic04.jpg">
			                            </div>
			                            <div>仪表台操纵杆</div>
			                        </dd>
