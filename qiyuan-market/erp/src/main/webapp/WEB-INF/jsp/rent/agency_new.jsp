...
<head>
    ...
    <script type="text/javascript">
        ...
        function ajaxPost(data2) {
            var url1 = ctutil.bp() + "/rent/agencyListAction!doCreateAction.action";
            $.ajax({
                cache: false,
                type: "POST",
                url: url1,
...
<div class="over-content">
    <form id="myForm">
        ...
        <div class="over-cell">
            <label>姓名:</label><input class="over-input" data-options="required:true,missingMessage:'请输入姓名'" id="agencyUserName" name="agency.userName" />
            <label>联系方式:</label><input class="over-input" data-options="required:true,missingMessage:'请输入联系方式'" id="agencyUserPhone" name="agency.userPhone"/>
        </div>
        <div class="over-cell"><label>身份证号:</label><input class="over-input" data-options="required:true,missingMessage:'请输入身份证号'" id="agencyUserIdCard" name="agency.userIdCard"/></div>
        <div class="over-title">公司信息</div>
        <div class="over-cell">
            <label>公司名称:</label><input class="over-input" data-options="required:true,missingMessage:'请输入公司名称'" id="agencyAgencyName" name="agency.agencyName"/>
            <label>法人:</label><input class="over-input" data-options="required:true,missingMessage:'请输入法人'" id="agencyLegalPersonName" name="agency.legalPersonName"/>
        </div>
        <div class="over-cell"><label>法人联系方式:</label><input class="over-input" data-options="required:true,missingMessage:'请输入法人联系方式'" id="agencyLegalPersonPhone" name="agency.legalPersonPhone"/></div>
    </form>
</div>
</body>
</html>
