...
<div class="over-content">
  <form id="myForm">
    ...
    <div class="over-cell">
      <label><span class="red">*</span>月平米租金</label>
    ...
    <div class="over-cell">
      <label><span class="red">*</span>租用面积</label>
      <span class="over-span"><input type="text" id="leaseCount" name="leaseCount"  onblur="javascript:calc()" /><b>㎡</b></span>
    </div>
    <div class="over-cell">
