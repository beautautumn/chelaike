...
<script>
      ...
      console.log(1);
        ...
        if(area=='-1'){
          $("#totalCountText").html("区域总面积：");
            ...
            $("#totalCount").val('');
            $("#freeCount").val('');
            $("#monthRentFee").val('').prop("readonly", true).attr("disabled", "disabled").css("background-color","#e6e6e6");
            $("#leaseCount").val('');
            $("#monthTotalFee").val('');
            $("#areaNo").val('');
          ...
          if(renttype=='0'){
                ...
                $("#monthRentFee").val(monthrentfee).prop("readonly", true).attr("disabled", "disabled").css("background-color","#e6e6e6");
                $("#leaseCount").val('');
                $("#monthTotalFee").val('');
                $("#areaNo").val('');
                $('#carCountTxt').removeAttr("style");
  ...
  function do_submit(){
    ...
    var date=$("#siteArea option:selected").attr('areaname')+";"+
		...
		api.get('contractSignPage').doGetSitePage(date);
   		api.get("getSitePage",1).close();
...
<div class="over-content">
  <form id="myForm">
    ...
    <div class="over-cell">
      <label><span class="red">*</span>场地区域</label>
      <select id="siteArea" class="over-select" name="siteArea" onchange="getChange()">
    ...
    <div class="over-cell">
      <label id="totalCountText">区域总面积</label>
      <input type="text" id="totalCount" name="totalCount" class="over-input"  readonly="readonly" disabled="disabled" />
    </div>
    <div class="over-cell">
      <label id="freeCountText">可租用面积</label>
      <input type="text" id="freeCount" name="freeCount" class="over-input"  readonly="readonly" disabled="disabled" />
    </div>
    <div class="over-cell">
      <label id="monthRentFeeText"><span class="red">*</span>月平米租金</label>
      <span class="over-span" style="background-color:#e6e6e6"><input type="text" id="monthRentFee" name="monthRentFee"  style="background-color:#e6e6e6"  readonly="readonly" disabled="disabled"  ><b>元</b></span>
    </div>
    <div class="over-cell">
      <label id="leaseCountText"><span class="red">*</span>租用面积</label>
      <span class="over-span"><input type="text" id="leaseCount" name="leaseCount"  onblur="javascript:calc()" /><b id="unitunit">㎡</b></span>
    </div>
    <div class="over-cell">
      <label><span class="red">*</span>月租金</label>
      <span class="over-span"><input type="text" id="monthTotalFee"  name="monthTotalFee" onblur="javascript:calc()" /><b>元</b></span>
    </div>
    <div class="over-cell">
      <label style="float: left;margin-right: 4px;"><span class="red">*</span>场地编号</label>
      <textarea class="over-textarea"  id="areaNo" name="areaNo" style="width:162px"  onkeyup="if(/[;]/.test(this.value)){var str = this.value;this.value =str.substring(0,str.length-1)}" ></textarea>
    </div>
    <div class="over-cell">
      <label><span class="red">*</span>车位数</label>
      <span class="over-span"><input type="text" id="carCount"  name="carCount" /><b>个</b></span>
    </div>
  </form>
</div>
<%--<form id="myForm">  --%>
      ...
      <%--<input type="hidden" id="areaNoAll" name="areaNoAll"/>--%>
        <%--<table>--%>
          ...
          <%--<tr style="width:500px;">--%>
            ...
            <%--<td class="text-l" width="200px;">--%>
              <%--<input type="text" id="monthTotalFee"  name="monthTotalFee" onblur="javascript:calc()" >&nbsp;元</input>--%>
            <%--</td>--%>
          <%--</tr>--%>
          <%--<tr style="width:500px;">--%>
            <%--<td class="text-r" width="100px;">&nbsp;</td>--%>
