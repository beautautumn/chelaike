...
<script>
	...
	function ajaxPost(data){
		$.ajax({
				cache: false,
				type: "POST",
				url:ctutil.bp()+"/rent/shopContractAction!clearContract.action",
				data:data,
				async: false,
				error: function() {
				html = "数据请求失败";
...
<div class="box">
	...
	<input type="hidden" name="shopContract.id" value="${shopContract.id}"/>
			<table>	
				<tr>
				...
				<tr> 
					...
					<td><textarea id="clearedDesc" style="width:280px;height:100px" name="shopContract.clearedDesc" /></textarea></td>
				</tr>
		</table>
</div>		
</form>					
