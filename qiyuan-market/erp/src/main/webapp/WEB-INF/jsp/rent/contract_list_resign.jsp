...
<script>
	...
	function openSiteArea(){
		...
		menu.create_child_dialog_identy(api,W,'getResignSitePage','选择场地区域',
    		'/rent/contractListAction!toResignSelectSiteArea.action?areaNoAll='+areaNoAll,
    		400,350,true);
    }
    function doGetSitePage(data){
	...
	function do_submit(){
		...
		$.ajax({
				cache: false,
				type: "POST",
				url:ctutil.bp()+"/rent/contractListAction!resignContract.action",
				data:data,
				async: false,
				error: function() {
				html = "数据请求失败";
				...
				success: function(data) {
				  if(data=="success"){
					  alert("保存成功！");
					  api.get("resignContractPage", 1).close();
					  W.query1();  //刷新副页面
				  }else{
					  alert("保存失败！");
					  api.get("resignContractPage", 1).close();
		...
		<div style="text-align:center;margin-top:20px;margin-left:60px;">
  			<table id="contract" name="contract">
  				<tr style="width:500px;">
  					...
  					<td width="160px;">
  						<input type="text"  id="startDate" name="contractBean.startDate"  onclick="WdatePicker()" onblur="setEndDate();"/>
  					</td>
  				...
  				<tr style="width:500px;">
  					<td class="text-r" width="100px;">合同收款周期：<span class="red">*</span></td>
  					<td width="150px;">
  				...
  				<tr style="width:500px;">
  					<td class="text-r" width="90px;">保证金：<span class="red">*</span></td>
  					<td width="160px;">
  						<input type="text" id="depositFee" name="contractBean.depositFee"  onblur="checkDepositFee();" />&nbsp;元<br />
  					</td>
  				...
  				<tr style="width:500px;">
  					<td class="text-r" width="90px;">市场签署人：<span class="red">*</span></td>
  					<td width="160px;">
  						<input type="text"  id="marketSignName" name="contractBean.marketSignName" value="${contract.marketSignName}"></input>
  					</td>
  					<td class="text-r" style="width:90px;" >商户签署人: <span class="red">*</span></td>
  					<td class="text-l" width="160px;">
  						<input type="text"  id="agencySignName" name="contractBean.agencySignName" value="${contract.agencySignName}"></input>
  					</td>
  				</tr>
