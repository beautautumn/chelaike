...
<head>
    ...
    <script type="text/javascript">
        ...
        function ajaxPost(data2) {
            var url1 = ctutil.bp() + "/checker/checker!cancelChecker7y.action";
            $.ajax({
                cache: false,
                type: "POST",
                url: url1,
...
<body>
<form id="myForm">
    <input type="hidden" name="checkerId" value="${checkerId}"/>
</form>
是否确认执行注销操作，确认后将无法更改，请谨慎操作。
</body>
</html>
