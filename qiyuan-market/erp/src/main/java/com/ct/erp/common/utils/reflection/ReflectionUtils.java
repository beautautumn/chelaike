package com.ct.erp.common.utils.reflection;
...
public class ReflectionUtils {
	...
	public static RuntimeException convertReflectionExceptionToUnchecked(
		...
		if ((e instanceof IllegalAccessException)
			...
			return new RuntimeException(((InvocationTargetException) e)
					.getTargetException());
	...
	public static <T extends Annotation> List<T> getAnnotations(
		...
		// 获取构造方法里的注解
		CollectionUtils.addAll(result, getAnnotations(constructors,
				annotationClass).iterator());
		...
		for (Class<?> superClass = targetClass.getSuperclass(); (superClass == null)
				...
				.getSuperclass()) {
			List<Annotation> temp = getAnnotations(superClass, annotationClass);
