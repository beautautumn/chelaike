...
/**
 * RecvDisposalHis entity. @author MyEclipse Persistence Tools
 */

public class RecvDisposalHis implements java.io.Serializable {
	...
	/** default constructor */
	public RecvDisposalHis() {
	}

	/** full constructor */
	public RecvDisposalHis(Financing financing, Staff staff, Integer recvFee,
