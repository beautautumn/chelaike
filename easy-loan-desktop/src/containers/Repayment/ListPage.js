...
import {
  ...
  setEvaluateVisible,
  setEvaluate
} from '../../models/reducers/repayment';
...
class ListPage extends React.Component {
  ...
  showOperationHistoryModal = record => {
    this.props.setOperationHistoryVisible({
      ...
      loanHistoryList: record.historyPcDtoList
    });
  };
  ...
  handleEvaluateOk = evaluate => {
    this.props.setEvaluate({ evaluate: evaluate });
  };
...
export default connect(
  state => {
    ...
    return {
      repayments: entitiesSelector('repayments')(state),
      total: state.repayments.total,
      query: state.repayments.query,
      loading: state.repayments.loading,
      confirmLoading: state.repayments.confirmLoading,
      visible: state.repayments.visible,
      evaluateVisible: state.repayments.evaluateVisible,
      car: state.repayments.car,
      brands,
      series: state.series.data,
      currentUser: user,
      assignees,
      operationHistoryVisible: state.repayments.operationHistoryVisible,
      loanHistoryList: state.repayments.loanHistoryList,
