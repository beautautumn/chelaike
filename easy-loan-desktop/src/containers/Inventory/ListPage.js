...
import { InventorySearchForm, InventoryTable } from 'components'
import { fetch, setVisible } from '../../models/reducers/inventory'
...
class ListPage extends React.Component {
  ...
  render() {
    const {
      inventories, loading,
      query, total,assignees,inventors
    } = this.props
...
export default connect(
  state => ({
    inventories: entitiesSelector('inventories')(state),
