...
import styles from './FInventoryDetailTable.scss';
...
export default class FDetailTable extends React.Component {
  renderStates(status) {
    if (!status) return;
  ...
  render() {
    ...
    if (data[0]) {
      ...
      console.log('inHallAndOutBaseCar', inHallAndOutBaseCar);
