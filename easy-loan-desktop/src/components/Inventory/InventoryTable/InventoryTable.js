...
import styles from './InventoryTable.scss';
              ...
              <div>
                {row.positioningAbnormal === true ? (
                  <span className={styles.color}>
                    <img src={WarningImg} alt="" /> {row.inventoryAddress}
                  </span>
                ) : (
