...
export const fetch = createApiAction('repayment/fetch');
export const changeStatus = createApiAction('repayment/changeStatus');
export const setVisible = createAction('repayment/setVisible');
export const setOperationHistoryVisible = createAction(
  'repayment/setOperationHistoryVisible'
);
export const setEvaluateVisible = createAction('repayment/setEvaluateVisible');
export const setEvaluate = createApiAction('repayment/setEvaluate');
export const fetchChe300Evaluate = createApiAction(
  'repayment/fetchChe300Evaluate'
);
