...
set :application, "official-site"
# set :repo_url, "git@git.che3bao.com:autobots/official-site.git"
set :repo_url, "git@git.chelaike.com:autobots/official-site.git"
...
set :puma_bind, -> { fetch(:stage).to_s == "prerelease" ? "tcp://0.0.0.0:9292" : "tcp://0.0.0.0:8181" }
