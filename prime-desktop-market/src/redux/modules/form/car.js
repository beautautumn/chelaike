...
import { CREATE_FAILURE, UPDATE_FAILURE } from '../cars'
import mapValues from 'lodash/mapValues'
import { computeNewCarFinalPrice } from 'redux/modules/carPrices'
import { fetchDetail } from '../styles'
...
export default (state, action) => {
  switch (action.type) {
    case fetchDetail.success.getType(): {
      const features = action.payload.carConfiguration
      features.forEach((group) => {
        group.fields.forEach((field) => {
