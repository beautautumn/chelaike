...
class Car < ActiveRecord::Base
  ...
  # 借款状态
  enumerize :loan_status, in: %i(loan noloan), predicates: { prefix: true }
  ...
  # 融资状态显示文字
  def loan_status_show_text
    {
      loan: "融资中",
      noloan: "未融资"
    }.fetch(loan_status, "融资中")
  end
