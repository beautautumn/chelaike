...
module CompanySerializer
  class AllianceDetail < ActiveModel::Serializer
    attributes :id, :name, :logo, :cars_count, :active_tag, :honesty_tag,
               :own_brand_tag, :contact, :contact_mobile, :note, :street

    has_many :alliance_contacts, serializer: UserSerializer::AllianceContact

    def cars_count
      object.alliance_cars_count
    end
  end
end
