...
module CarSerializer
  class StatisticsList < ActiveModel::Serializer
    attributes :id, :level, :reserved, :cover_url, :licensed_at, :license_info, :name,
               :mileage, :show_price_wan, :stock_number, :exterior_color, :stock_age_days,
               :yellow_stock_warning_days, :red_stock_warning_days, :state, :state_text,
               :system_name, :closing_cost_wan, :stock_out_at, :estimated_gross_profit_wan
  end
end
