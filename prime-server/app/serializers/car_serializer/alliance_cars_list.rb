...
module CarSerializer
  class AllianceCarsList < ActiveModel::Serializer
    attributes :id, :cover_url, :name, :licensed_at, :mileage, :show_price_wan,
               :stock_number, :exterior_color, :company,
               :brand_name, :series_name, :style_name, :system_name

    belongs_to :company, serializer: CompanySerializer::Alliance
  end
end
