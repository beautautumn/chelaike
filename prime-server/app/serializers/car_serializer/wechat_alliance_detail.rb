...
module CarSerializer
  class WechatAllianceDetail < ActiveModel::Serializer
    attributes :online_price_wan, :show_price_wan, :stock_number, :new_car_guide_price_wan,
               :licensed_at, :mileage, :transmission, :exterior_color, :interior_color,
               :manufactured_at, :displacement, :car_type, :selling_point, :mortgage_note,
               :seller, :company, :manufacturer_configuration, :name, :fuel_type,
               :is_turbo_charger, :configuration_note, :license_info, :system_name
    ...
    def company
...

      {
        ...
        contact_mobile: scope.company.contact_mobile
      }
    end
  end
end
