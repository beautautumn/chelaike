...
ActiveRecord::Schema.define(version: 20180514023449) do
  ...
  create_table "app_versions", force: :cascade, comment: "app版本控制" do |t|
    ...
    t.string   "ios_source",                                         comment: "ios的外部安装源"
  end
  ...
  create_table "cars", force: :cascade, comment: "车辆" do |t|
    ...
    t.integer  "estimate_price_cents",           limit: 8,                                           comment: "车辆估值"
    t.integer  "loan_bill_id",                                                                       comment: "车辆所属的借款单ID"
    t.string   "loan_status",                                                                        comment: "借款状态，借款 loan，未借款 noloan"
  end
  ...
  create_table "check_tasks", force: :cascade, comment: "检测任务" do |t|
    t.string   "task_type",                       comment: "任务类型"
    t.string   "task_report_h5_url",              comment: "生成报告url"
    t.integer  "car_id",                          comment: "对应车辆"
    t.integer  "create_staff_id",                 comment: "任务创建者(车商)"
    t.integer  "check_staff_id",                  comment: "检测者(检测员)"
    t.string   "task_state",                      comment: "检测任务状态"
    t.integer  "trade_id",                        comment: "对应erp里车辆id"
    t.integer  "integer",                         comment: "对应erp里车辆id"
    t.string   "report_type",                     comment: "检测报告类型"
    t.string   "string",                          comment: "检测报告地址"
    t.string   "report_url",                      comment: "检测报告地址"
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
  end

  add_index "check_tasks", ["car_id"], name: "index_check_tasks_on_car_id", using: :btree
  ...
  create_table "intention_levels", force: :cascade, comment: "意向级别" do |t|
    ...
    t.string   "company_type",    default: "Company",              comment: "所属公司类型"
  end
  ...
  create_table "intentions", force: :cascade, comment: "意向" do |t|
    ...
    t.integer  "alliance_intention_level_id",                                                                  comment: "联盟客户级别"
  ...
  create_table "maintenance_settings", force: :cascade do |t|
    ...
    t.decimal "dashenglaile_unit_price", precision: 8, scale: 2, default: 29.0
  end
