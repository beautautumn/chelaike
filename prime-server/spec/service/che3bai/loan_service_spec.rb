...
RSpec.describe Che3bai::LoanService do
  ...
  describe "#megatron_styles_by_vin(vin)" do
    before do
      WebMock.allow_net_connect!
      VCR.turn_off!
    end

    it "根据vin码得到我们车型库里的车型信息" do
      vin = "LE4HG3GB4EL181126"
      service = Che3bai::LoanService.new
      result = service.megatron_styles_by_vin(vin)
