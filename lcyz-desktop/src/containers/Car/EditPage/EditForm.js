...
export default class EditForm extends Component {
  ...
  render() {
    const { values, pristine, fields, handleSubmit, handleCancel, shopId, enumValues } = this.props
    const carId = values.car.id
    ...
    return (
      ...
      {this.isUseable('publisher') && [
        this.renderScrollSpy('publisher', 'features'),
        <Forms.publisher
          key="publisher"
          fields={fieldsGroup.publisher}
          dirty={!pristine}
          id={carId}
        />
      ]}
