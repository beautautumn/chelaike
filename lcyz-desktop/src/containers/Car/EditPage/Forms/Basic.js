...
class Basic extends Component {
  ...
  render() {
    ...
    const { inHallCarStates, enumValues } = this.props
    ...
    return (
      <Element name="basic" className={styles.formPanel}>
        ...
        <Row>
          <Col span="12">
            <FormItem {...formItemLayout} field={stockNumber} label="库存编号：" >
              <Input placeholder="不填则由系统自动分配" {...stockNumber} />
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem {...formItemLayout} field={vin} label="车架号：" >
              <Input {...vin} />
            </FormItem>
          </Col>
        </Row>
          ...
          <Row>
            <Col span="12">
              <FormItem {...formItemLayout} label="车辆状态：" >
                <Select
                  items={map(inHallCarStates, (text, key) => ({ value: key, text }))}
                  {...state}
                />
              </FormItem>
            </Col>
        ...
        <Row>
          ...
          <Col span="12">
            <FormItem {...formItemLayout} label="出厂年月：" >
