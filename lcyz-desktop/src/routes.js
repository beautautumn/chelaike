...
import ExportSale from './containers/Export/ExportSale'
import ExportStock from './containers/Export/ExportStock'
import ExportCustomer from './containers/Export/ExportCustomer'
    ...
    <Route component={App}>
      ...
      <Route component={AppLayout} onEnter={requireAuth}>
        ...
        <Route path="setting" component={Setting.Layout} >
          <IndexRoute component={Setting.Shop.ListPage} />
          ...
          <Route path="defeat_reason" component={Setting.DefeatReason.ListPage} />
        </Route>
        <Route path="weshop">
        ...
        <Route path="export_stock" component={ExportStock} />
        <Route path="export_customer" component={ExportCustomer} />
        <Route path="export_sale" component={ExportSale} />
      </Route>
      <Route path="login" component={Auth.LoginPage} />
