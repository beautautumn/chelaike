...
class Tenant < ApplicationRecord
  ...
  enumerize :tenant_type, in: %i(company shop)
  attr_accessor :company, :shop, :host
  ...
  def combination_id
    return company_id if tenant_type == "company"
    return "#{company_id}_#{shop_id}" if tenant_type == "shop"
  end
