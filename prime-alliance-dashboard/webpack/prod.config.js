...
var extract = new ExtractTextPlugin('[name]-[chunkhash].css', { allChunks: true });
...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /\.(css|less)/, loader: extract.extract('style', 'css!less')},
      { test: /\.scss$/, loader: extract.extract('style', 'css?modules&importLoaders=2!postcss!sass?outputStyle=expanded') },
