...
RSpec.describe Open::V1::BrandsController do
  fixtures :all
  ...
  describe "GET /api/open/v1/brands" do
    it "获取所有品牌" do
  ...
  describe "GET /api/open/v1/series?brand[name]=奥迪" do
    it "获取奥迪的所有车系" do
  ...
  describe "GET /api/open/v1/styles?series[name]=奥迪A3&" do
    it "获取奥迪A3的所有车款" do
  ...
  describe "GET /api/open/v1/style" do
