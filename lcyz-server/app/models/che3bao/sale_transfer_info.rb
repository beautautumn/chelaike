...
module Che3bao
  class SaleTransferInfo < ActiveRecord::Base
    # accessors .................................................................
    # extends ...................................................................
    # includes ..................................................................
    include Che3baoConnection
    # relationships .............................................................
    has_one :stock, class_name: Stock.name, foreign_key: :sale_transfer_id

    belongs_to :sell_staff_user, foreign_key: :sell_staff, class_name: Staff.name
    # validations ...............................................................
    # callbacks .................................................................
    # scopes ....................................................................
    # additional config .........................................................
    ...
    def items
      arr = []
      arr.concat(TransferItem.items(transfer_item.split(","))) if transfer_item.present?
      arr << "commercial_insurance" if stock.vehicle.commercial_insurance_end_at.present?
