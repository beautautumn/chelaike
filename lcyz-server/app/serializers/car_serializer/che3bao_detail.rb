...
module CarSerializer
  class Che3baoDetail < ActiveModel::Serializer
    include CarSerializer::Che3baoConcern

    attributes :carPrice, :brandCode, :brandName, :seriesCode, :seriesName,
               :modelCode, :modelName, :vehicleName, :registerMonth, :mileageNum,
               :carColor, :upholsteryColor, :dimCodeUrl, :vinCode, :carType,
               :outputVolumn, :turboCharger, :fuelType, :gearsType, :issurValidDate,
               :commIssurValidDate, :checkValidMonth, :envLevel, :condDesc,
               :mortgageDesc, :standardEquip, :custEquip, :shopName, :bigPicAddr,
               :manufacturer_configuration_hash, :carState, :marketDesc, :corpPhone,
               :newCarHandprice
  end
end
