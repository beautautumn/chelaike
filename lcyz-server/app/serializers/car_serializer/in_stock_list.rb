...
module CarSerializer
  class InStockList < ActiveModel::Serializer
    include CarSerializer::Concern

    has_one :acquisition_transfer, serializer: TransferRecordSerializer::Acquisition
    ...
    belongs_to :company, serializer: CompanySerializer::Mini, if: :nickname?

    has_one :alliance_stock_in_inventory,
            serializer: AllianceStockOutInventorySerializer::Base

    def nickname?
      instance_options[:nickname]
    end
