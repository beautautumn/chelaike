module Wechat
  class Reducer
    ...
    EVENT_SUBSCRIBE = "subscribe".freeze
    EVENT_UNSUBSCRIBE = "unsubscribe".freeze
    EVENT_SCAN = "SCAN".freeze
    EVENT_CLICK = "CLICK".freeze

    PRICE_TAG_SCAN = "1".freeze
    CHANNEL_SCAN = "2".freeze
