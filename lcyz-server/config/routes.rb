...
Rails.application.routes.draw do
  scope :api do
    ...
    namespace :v1 do
      ...
      resources :owner_companies, only: [:index, :update, :create, :destroy, :show] do
        collection do
          get :query
          get :query_shop
        end
      end
      resources :intention_push_fail_reasons, only: [:index, :update, :create, :destroy, :show] do
        collection do
          get :app_index
        end
      end
