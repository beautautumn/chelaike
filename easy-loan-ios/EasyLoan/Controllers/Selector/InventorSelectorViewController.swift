...
class InventorSelectorViewController: BaseSearchableSingleSelectListViewController {
    
    override func viewDidLoad() {
        super.viewDidLoad()
        self.searchBar.textField.placeholder = "搜索盘库员"
        self.loadData()
    }
    ...
    func loadData(_ keyword: String? = nil) {
        ...
        let _ = InventorApi.list(keyword ?? "").subscribeOn(ConcurrentMainScheduler.instance)
